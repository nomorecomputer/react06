...
const ProductModal = memo(({ product, addCart, closeProductModal }) => {
  const [addCartQty, setAddCartQty] = useState(1);
  const handleAddCart = () => {
    addCart(product.id, addCartQty);
    closeProductModal();
  };
            ...
            <div className="modal-body">
              ...
              <div className="d-flex align-items-center">
                ...
                <input
                  ...
                  //   value={"0"}
                  value={addCartQty ?? "1"}
                  onChange={(e) => setAddCartQty(Number(e.target.value))}
                />
                <button
                  ...
                  aria-label="Decrease quantity"
                  onClick={() =>
                    setAddCartQty((prev) => (prev + 1 > 10 ? 10 : prev + 1))
                  }
                >
